...
const getObjectTaggingOutputResponse: S3.GetObjectTaggingOutput = { TagSet: [{ Key: 'Tag1', Value: 'Tag1Value', } as S3.Tag] };
const headBucketOutputResponse: object = {};
const headObjectOutputResponse: S3.HeadObjectOutput = { Metadata: { key1: 'value1' } };
...
const completeMultipartUpload = jest.fn().mockImplementation(() => {
    return Promise.resolve<S3.CompleteMultipartUploadOutput>(completeMultipartUploadOutputResponse);
});
...
const createMultipartUpload = jest.fn().mockImplementation(() => {
    return Promise.resolve<S3.CreateMultipartUploadOutput>(createMultipartUploadOutputResponse);
});
...
const deleteObjectTagging = jest.fn().mockImplementation(() => {
    return Promise.resolve<S3.DeleteObjectTaggingOutput>(deleteObjectTaggingOutputResponse);
});
...
const getObjectTagging = jest.fn().mockImplementation(() => {
    return Promise.resolve<S3.GetObjectTaggingOutput>(getObjectTaggingOutputResponse);
});
...
const putObjectTagging = jest.fn().mockImplementation(() => {
    return Promise.resolve<S3.PutObjectTaggingOutput>(putObjectTaggingOutputResponse);
});
...
describe(`${S3Helper.name}.${s3HelperMock.CopyObjectAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} sourceBucket`, () => {
        const actual = s3HelperMock.CopyObjectAsync(TestValues.EmptyString, TestValues.Key, TestValues.Name, TestValues.Key);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} sourceBucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} sourceKey`, () => {
        const actual = s3HelperMock.CopyObjectAsync(TestValues.Name, TestValues.EmptyString, TestValues.Name, TestValues.Key);
    ...
    test(`${TestValues.ThrowsOnEmpty} destinationBucket`, () => {
        const actual = s3HelperMock.CopyObjectAsync(TestValues.Name, TestValues.Key, TestValues.EmptyString, TestValues.Key);
    ...
    test(`${TestValues.ThrowsOnEmpty} destinationKey`, () => {
        const actual = s3HelperMock.CopyObjectAsync(TestValues.Name, TestValues.Key, TestValues.Name, TestValues.EmptyString);
...
describe(`${S3Helper.name}.${s3HelperMock.DeleteObjectTagsAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} bucket`, () => {
        const actual = s3HelperMock.DeleteObjectTagsAsync(TestValues.EmptyString, TestValues.Name);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} bucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} key`, () => {
        const actual = s3HelperMock.DeleteObjectTagsAsync(TestValues.Name, TestValues.EmptyString);
...
describe(`${S3Helper.name}.${s3HelperMock.DeleteObjectAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} bucket`, () => {
        const actual = s3HelperMock.DeleteObjectAsync(TestValues.EmptyString, TestValues.Key);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} bucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} key`, () => {
        const actual = s3HelperMock.DeleteObjectAsync(TestValues.Name, TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} key`);
    });
    test(TestValues.ValidTest, () => {
...
describe(`${S3Helper.name}.${s3HelperMock.DeleteObjectsAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} bucket`, () => {
        const actual = s3HelperMock.DeleteObjectsAsync(TestValues.EmptyString, [TestValues.Key]);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} bucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} key array`, () => {
        const actual = s3HelperMock.DeleteObjectsAsync(TestValues.Name, TestValues.EmptyArray);
...
describe(`${S3Helper.name}.${s3HelperMock.GetObjectAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} bucket`, () => {
        const actual = s3HelperMock.GetObjectAsync(TestValues.EmptyString, TestValues.Key);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} bucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} key`, () => {
        const actual = s3HelperMock.GetObjectAsync(TestValues.Name, TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} key`);
    });
    test(TestValues.ValidTest, () => {
...
describe(`${S3Helper.name}.${s3HelperMock.GetObjectMetadataAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} bucket`, () => {
        const actual = s3HelperMock.GetObjectMetadataAsync(TestValues.EmptyString, TestValues.Name);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} bucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} key`, () => {
        const actual = s3HelperMock.GetObjectMetadataAsync(TestValues.Name, TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} key`);
    });
    test(TestValues.ValidTest, () => {
...
describe(`${S3Helper.name}.${s3HelperMock.GetObjectTagsAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} bucket`, () => {
        const actual = s3HelperMock.GetObjectTagsAsync(TestValues.EmptyString, TestValues.Key);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} bucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} key`, () => {
        const actual = s3HelperMock.GetObjectTagsAsync(TestValues.Name, TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} key`);
    });
    test(TestValues.ValidTest, () => {
...
describe(`${S3Helper.name}.${s3HelperMock.MoveObjectAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} sourceBucket`, () => {
        const actual = s3HelperMock.MoveObjectAsync(TestValues.EmptyString, TestValues.Key, TestValues.Name, TestValues.Key);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} sourceBucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} sourceKey`, () => {
        const actual = s3HelperMock.MoveObjectAsync(TestValues.Name, TestValues.EmptyString, TestValues.Name, TestValues.Key);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} sourceKey`);
    });
    test(`${TestValues.ThrowsOnEmpty} destinationBucket`, () => {
        const actual = s3HelperMock.MoveObjectAsync(TestValues.Name, TestValues.Key, TestValues.EmptyString, TestValues.Key);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} destinationBucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} destinationKey`, () => {
        const actual = s3HelperMock.MoveObjectAsync(TestValues.Name, TestValues.Key, TestValues.Name, TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} destinationKey`);
    });
    test(TestValues.ValidTest, () => {
...
describe(`${S3Helper.name}.${s3HelperMock.MultipartUploadCompleteAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} bucket`, () => {
        const actual = s3HelperMock.MultipartUploadCompleteAsync(TestValues.EmptyString, TestValues.Key, TestValues.UploadId);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} bucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} key`, () => {
        const actual = s3HelperMock.MultipartUploadCompleteAsync(TestValues.Name, TestValues.EmptyString, TestValues.UploadId);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} key`);
    });
    test(`${TestValues.ThrowsOnEmpty} uploadId`, () => {
        const actual = s3HelperMock.MultipartUploadCompleteAsync(TestValues.Name, TestValues.Key, TestValues.EmptyString);
    ...
    test(TestValues.ValidTest, () => {
        ...
        return expect(actual).resolves.toEqual(completeMultipartUploadOutputResponse);
    });
});
...
describe(`${S3Helper.name}.${s3HelperMock.MultipartUploadStartAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} bucket`, () => {
        const actual = s3HelperMock.MultipartUploadStartAsync(TestValues.EmptyString, TestValues.Key);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} bucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} key`, () => {
        const actual = s3HelperMock.MultipartUploadStartAsync(TestValues.Name, TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} key`);
    });
    test(TestValues.ValidTest, () => {
...
describe(`${S3Helper.name}.${s3HelperMock.MultipartUploadUploadPartAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} bucket`, () => {
        const actual = s3HelperMock.MultipartUploadUploadPartAsync(TestValues.EmptyString, TestValues.Key, TestValues.UploadId, TestValues.UploadPart, TestValues.Body);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} bucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} key`, () => {
        const actual = s3HelperMock.MultipartUploadUploadPartAsync(TestValues.Name, TestValues.EmptyString, TestValues.UploadId, TestValues.UploadPart, TestValues.Body);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} key`);
    });
    test(`${TestValues.ThrowsOnEmpty} uploadId`, () => {
        const actual = s3HelperMock.MultipartUploadUploadPartAsync(TestValues.Name, TestValues.Key, TestValues.EmptyString, TestValues.UploadPart, TestValues.Body);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} uploadId`);
    });
    test(`${TestValues.CannotBeZero} uploadId`, () => {
        const actual = s3HelperMock.MultipartUploadUploadPartAsync(TestValues.Name, TestValues.Key, TestValues.UploadId, 0, TestValues.Body);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.CannotBeZero} - uploadId`);
    });
    test(`${TestValues.ThrowsOnEmpty} contents`, () => {
        const actual = s3HelperMock.MultipartUploadUploadPartAsync(TestValues.Name, TestValues.Key, TestValues.UploadId, TestValues.UploadPart, TestValues.EmptyString);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} contents`);
    });
    test(`contents too small`, () => {
        const actual = s3HelperMock.MultipartUploadUploadPartAsync(TestValues.Name, TestValues.Key, TestValues.UploadId, TestValues.UploadPart, TestValues.Body);
...
describe(`${S3Helper.name}.${s3HelperMock.PutObjectAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} bucket`, () => {
        const actual = s3HelperMock.PutObjectAsync(TestValues.EmptyString, TestValues.Key, TestValues.Body);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} bucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} key`, () => {
        const actual = s3HelperMock.PutObjectAsync(TestValues.Name, TestValues.EmptyString, TestValues.Body);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} key`);
    });
    test(TestValues.ValidTest, () => {
...
describe(`${S3Helper.name}.${s3HelperMock.SetObjectTagAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} bucket`, () => {
        const actual = s3HelperMock.SetObjectTagAsync(TestValues.EmptyString, TestValues.Key, TestValues.Name, TestValues.Name);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} bucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} key`, () => {
        const actual = s3HelperMock.SetObjectTagAsync(TestValues.Name, TestValues.EmptyString, TestValues.Name, TestValues.Name);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} key`);
    });
    test(`${TestValues.ThrowsOnEmpty} tagName`, () => {
        const actual = s3HelperMock.SetObjectTagAsync(TestValues.Name, TestValues.Key, TestValues.EmptyString, TestValues.Name);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} tagName`);
    });
    test(`${TestValues.ThrowsOnEmpty} tagValue`, () => {
        const actual = s3HelperMock.SetObjectTagAsync(TestValues.Name, TestValues.Key, TestValues.Name, TestValues.EmptyString);
...
describe(`${S3Helper.name}.${s3HelperMock.SetObjectTagsAsync.name}`, () => {
    ...
    test(`${TestValues.ThrowsOnEmpty} bucket`, () => {
        const actual = s3HelperMock.SetObjectTagsAsync(TestValues.EmptyString, TestValues.Key, TestValues.FileTags);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} bucket`);
    });
    test(`${TestValues.ThrowsOnEmpty} key`, () => {
        const actual = s3HelperMock.SetObjectTagsAsync(TestValues.Name, TestValues.EmptyString, TestValues.FileTags);
        return expect(actual).rejects.toThrow(`[${action}]-${TestValues.MustSupply} key`);
    });
    test(`${TestValues.ThrowsOnEmpty} tags`, () => {
        const actual = s3HelperMock.SetObjectTagsAsync(TestValues.Name, TestValues.Key, TestValues.EmptyArray);
